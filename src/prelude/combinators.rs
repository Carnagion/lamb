...
///
/// This is α-equivalent to the term `λf g x. f (g x)`.
...
///
/// This is α-equivalent to the term `λf x y. f y x`.
...
///
/// This is α-equivalent to the term `λx. x`.
...
///
/// This is α-equivalent to the term `λx y. x`.
...
///
/// This is α-equivalent to the term `ω ω`, where `ω` is the self-applying combinator (see [app_self]).
...
///
/// This is α-equivalent to the term `λx y. y x`.
...
///
/// This is α-equivalent to the term `λx y z. x z (y z)`.
...
///
/// This is α equivalent to the term `(λx y. y (x x y)) (λx y. y (x x y))`.
...
///
/// This is α-equivalent to the term `λf x. f x x`.
...
///
/// This is α-equivalent to the term `λf. (λx. f (x x)) (λx. f (x x))`.
...
///
/// This is α-equivalent to the term `λf. (λx. f (λy. x x y)) (λx. f (λy. x x y))`.
...
///
/// This is α-equivalent to the term `λx. x S K`, where `S` is the substitution combinator (see [sub]) and `K` is the constant combinator (see [constant]).
...
///
/// This is α-equivalent to the term `λx. x x`.
